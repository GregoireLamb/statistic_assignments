...
$$\text{#Boostrap samples} = {2n + 1\choose n} = {25 \choose 12} = 5200300$$
...
knitr::kable(table, caption = "SE and Confidence intervals for differnt estimators")

```

4. Use parametric bootstrap (based on x and x.clean) to calculate, for the mean and the trimmed mean:
- bias
- standard error
- 95 percentile CI
