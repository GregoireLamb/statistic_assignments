...
To observe the c_value influence, we will compute the condition number with 10 c-values between the min and the max of the data set and we will also compute the condition number with the mean as c-value.
